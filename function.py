...
def create_model(hidden_nodes,loss_function):
    ...
    model.add(Dense(hidden_nodes, activation='relu',kernel_regularizer=l2(0.0001), input_shape=(784,)))
    model.add(Dense(397, activation='relu',kernel_regularizer=l2(0.0005)))
    model.add(Dense(10, activation='softmax'))
    optimizer = keras.optimizers.SGD(lr=0.1,momentum = 0.6)
